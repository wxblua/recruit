...
public class SmsVerification {
	...
	public static final String ACCOUNT_SID = "c2138da99b314a63b94cf53904d702d9";
	 // 注册后系统自动生成的TOKEN
	public static final String AUTH_TOKEN = "a0f865cbc6e0426ca59e9c92d7c0abac";
	//响应数据类型, JSON或XML
	public static final String RESP_DATA_TYPE = "json";
	private static int verificationCode=(int)((Math.random() * 9 + 1) * 100000); //随机验证码
	private static String smsContent = "【浩周科技】尊敬的用户，您的验证码为"+verificationCode;//短信签名+内容（用模板不能自定义必须和模板一致）
