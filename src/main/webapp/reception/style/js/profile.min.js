            ...
            $(".projectForm").each(function() {
                $(this).validate({
                    ...
                    submitHandler: function(a) {
                        var reid=$("#reid").val()
                        var b = $('input[name="pjname"]', a).val()
                            , c = $('input[name="pjresponsibilitys"]', a).val()
                        ...
                        $(a).find(":submit").val("保存中...").attr("disabled", !0),
                            $.ajax({
                                url:"../projectperience/addprojectperi?reid="+reid,
                                type: "POST",
                                data: {
                                    pjname: b,
                                    pjresponsibility: c,
                                ...
                                $("#resubmitToken").val(b.resubmitToken),
                                    b.success ? (c = b.content.projectExperience,
                                        ...
                                        3 == b.code ? "" != c ? (e += '<li data-id="' + c.id + '">',
                                            e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.pjname + '" data-posName="' + c.positionName + '" data-startY="' + c.startYear + '" data-startM="' + c.startMonth + '" data-endY="' + c.endYear + '"' + 'data-endM="' + c.endMonth + '">' + c.pjnameAndRemark + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>",
                                        ...
                                        "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) && $(a).remove(),
                                            ...
                                            d.obj.children(".projectAdd").removeClass("dn")) : 4 == b.code ? (e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.pjname + '" data-posName="' + c.positionName + '" data-startY="' + c.startYear + '" data-startM="' + c.startMonth + '" data-endY="' + c.endYear + '"' + 'data-endM="' + c.endMonth + '">' + c.pjnameAndRemark + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>",
                                        "" != c.projectRemark && (e += '<div class="dl1">' + c.projectRemark + "</div>"),
                                            e += "</div>",
        ...
        window.onbeforeunload = function() {
            ...
            $("#expectForm").validate({
                ...
                submitHandler: function(a) {
                    ...
                    $(a).find(":submit").val("保存中...").attr("disabled", !0),
                        $.ajax({
                            url: "../Intention/addIntention?reid="+reid,
                            type: "POST",
                            data: {
                                city: c,
                                positionType: d,
                            ...
                            if(g){
                                ...
                                $.ajax({
                                    ...
                                    dataType:"json",
                                    success:function(data) {
                                        $("#inpositionid").html(data[0].inpositionid);
                                        $("#inworknature").html(data[0].inworknature);
                                        $("#insalary").html(data[0].insalary);
                                        $("#inworkaddress").html(data[0].inworkaddress);
                ...
                $(this).validate({
                    ...
                    submitHandler: function(a) {
                        ...
                        var b = $('input[name="companyName"]', a).val()
                            ...
                            , j = $("#resumeId").val()
                            , l = $("#resubmitToken").val()
                            , o = $("#wpworkdescribess").val()
                            , n = $(".companyName").val();
                        $(a).find(":submit").val("保存中...").attr("disabled", !0),
                            $.ajax({
                                url: "../workexperience/addworkperi?reid="+reid,
                                type: "POST",
                                data: {
                                    companyName: b,
                                    positionName: d,
            ...
            d = {
                ...
                resetForm: function() {
                    this.obj.children(".projectEdit").find(".pjname").val(""),
                        this.obj.children(".projectEdit").find(".pjresponsibilitys").val(""),
                ...
                Edit: function(a) {
                    ...
                    l && (l = $.trim(l.replace(/<br>/gi, ""))),
                        ...
                        m.find(".pjname").val(d),
                        m.find(".pjresponsibilitys").val(f),
            ...
            $(".educationalForm").each(function() {
                $(this).validate({
                    ...
                    submitHandler: function(a) {
                        ...
                        $(a).find(":submit").val("保存中...").attr("disabled", !0),
                            $.ajax({
                                url:"../backeducation/addBackeducation?reid="+reid,
                                type: "POST",
                                data: {
                                    schoolName: b,
                                    education: c,
            ...
            $(".descriptionForm").validate({
                ...
                submitHandler: function(a) {
                    var reid=$("#reid").val()
                    alert($("radio[name='inster']").val())
                    alert($('radio[name="liter"]',a).val())
                    var b = $('textarea[name="selfDescription"]', a).val()
                        , q = $('radio[name="inster"]',a).val()
                        , m = $('radio[name="liter"]',a).val()
                        , n = $("#lanuage").val()
                        , c = $("#resumeId").val()
                        , d = $("#resubmitToken").val();
                    $(a).find(":submit").val("保存中...").attr("disabled", !0),
                        $.ajax({
                            url:"../other/addother?reid="+reid,
                            type: "POST",
                            data: {
                                myRemark: b,
                                insteringandspeak:q,
