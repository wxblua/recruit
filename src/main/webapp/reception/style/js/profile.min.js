...
function img_check() {
    ...
    var d=".jpg,.jpg,.jpeg,.gif,.png";
    if(0 != d && -1 != d.indexOf(c)){
        $.ajaxFileUpload({
            url:"../resume/fileUpdate",
            secureuri:false,
            fileElementId:'headPic',//file标签的id
            ...
            success:function(data){
                if(data){
                    $("#imgss").attr("src","style/img/"+b);
                    $("#aimg").attr("src","style/img/"+b);
                }else{
                    errorTips("图片格式错误，请重新上传")
                }
            }
        })
    }else{
        errorTips(c+"不是图片格式，请重新上传")
    }
}
    ...
    $(function() {
                                ...
                                $("#resubmitToken").val(b.resubmitToken),
                                    b.success ? (c = b.content.projectExperience,
                                        ...
                                        3 == b.code ? "" != c ? (e += '<li data-id="' + c.id + '">',
                                            e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.projectName + '" data-posName="' + c.wpinposition + '" data-startY="' + c.startYear + '" data-startM="' + c.startMonth + '" data-endY="' + c.endYear + '"' + 'data-endM="' + c.endMonth + '">' + c.projectNameAndRemark + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>",
                                        ...
                                        "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) && $(a).remove(),
                                            ...
                                            d.obj.children(".projectAdd").removeClass("dn")) : 4 == b.code ? (e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.projectName + '" data-posName="' + c.wpinposition + '" data-startY="' + c.startYear + '" data-startM="' + c.startMonth + '" data-endY="' + c.endYear + '"' + 'data-endM="' + c.endMonth + '">' + c.projectNameAndRemark + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>",
                                        "" != c.projectRemark && (e += '<div class="dl1">' + c.projectRemark + "</div>"),
                                            e += "</div>",
        ...
        window.onbeforeunload = function() {
                            ...
                            /*   if ($("#resubmitToken").val(g.resubmitToken),
                                   ...
                                   if (c || d || e || f) {
                                       ...
                                       b.obj.find(".expectShow").children("span").html(h).parent().removeClass("dn"),
                                           $(a).obj.find(".c_edit").removeClass("dn"),
                                           ...
                                           b.obj.find("#expectPositionVal").val(g.content.resume.wpinposition),
                                           ...
                                           b.expectPositionVal = g.content.resume.wpinposition,
            ...
            c = {
                ...
                companyMonthEndVal: "",
                Add: function() {
                    this.obj.children(".experienceEdit").find(".wpcompanyname").val(""),
                        this.obj.children(".experienceEdit").find(".wpinposition").val(""),
                ...
                AddMore: function() {
                    this.obj.children(".experienceShow").find(".wpcompanyname").val(""),
                        this.obj.children(".experienceShow").find(".wpinposition").val(""),
                ...
                Edit: function(a) {
                    ...
                    a.parent("li").find("img").attr("src"),
                        ...
                        this.obj.children(".experienceShow").find(".wpcompanyname").val(i),
                        this.obj.children(".experienceShow").find(".wpinposition").val(h),
                    ...
                    "至今" == $.trim(f) && this.obj.children(".experienceShow").find(".select_companyMonthEnd").unbind("click"),
                        this.wpcompanynameVal = i,
                        this.wpinpositionVal = h,
            ...
            c.obj.delegate(".wpcompanyname", "keyup", function() {
                var a = $.trim($(this).val());
                "" != a && suggestCompany(a, ".wpcompanyname")
            }),
            c.obj.delegate(".wpinposition", "keyup", function() {
                var a = $.trim($(this).val());
                "" != a && suggestPosition(a, ".wpinposition")
            }),
            $(".experienceForm").each(function() {
                $(this).validate({
                    ...
                    submitHandler: function(a) {
                        var b = $('input[name="wpcompanyname"]', a).val()
                            , d = $('input[name="wpinposition"]', a).val()
                        ...
                        $(a).find(":submit").val("保存中...").attr("disabled", !0),
                            $.ajax({
                                url: "../workexperience/workexperienceUpdate",
                                type: "POST",
                                data: {
                                    wpcompanyname: b,
                                    wpinposition: d,
                                 ...
                                 if ($("#resubmitToken").val(b.resubmitToken),
                                     ...
                                     for (d = b.content.workExperiences,
                                         ...
                                         e += 0 == f % 2 ? '<li data-id="' + d[f].id + '" class="clear">' : '<li data-id="' + d[f].id + '">',
                                             e += '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startYear="' + d[f].startYear + '" data-endYear="' + d[f].endYear + '" data-startMonth = "' + d[f].startMonth + '" data-endMonth = "' + d[f].endMonth + '">' + d[f].startDate + "-" + d[f].endDate + "</span>" + "<div>" + '<img src="' + ctx + "/" + d[f].companyLogo + '" width="56" height="56" alt="' + d[f].wpcompanyname + '" />' + "<h3>" + d[f].wpinposition + "</h3>" + "<h4>" + d[f].wpcompanyname + "</h4>" + "</div>" + "</li>";
